...
static unsigned short tune_camera_ove1[] = {
	/*start MC ove 1*/
	0x0000, 0x0000,	/*BANK 0*/
	0x0008, 0x04a0,	/*Dither8 UC4 ABC2 CP1 | CC8 MCM4 SCR2 SCC1 | CS8 DE4 DNR2 HDR1*/
	0x00e1, 0xff00,	/*SCR RrCr*/
	0x00e2, 0x18ff,	/*SCR RgCg*/
	0x00e3, 0x13ff,	/*SCR RbCb*/
	0x00e4, 0x00ff,	/*SCR GrMr*/
	0x00e5, 0xff00,	/*SCR GgMg*/
	0x00e6, 0x00fa,	/*SCR GbMb*/
	0x00e7, 0x00ff,	/*SCR BrYr*/
	0x00e8, 0x00fa,	/*SCR BgYg*/
	0x00e9, 0xff00,	/*SCR BbYb*/
	0x00ea, 0x00ff,	/*SCR KrWr*/
	0x00eb, 0x00ff,	/*SCR KgWg*/
	0x00ec, 0x00ff,	/*SCR KbWb*/
	...
	0x00d0, 0x0155,	/*UC y*/
	0x00d1, 0x0155,	/*UC cs*/
	0x00d4, 0x002f,	/*UC ymap 0 1*/
	0x00d5, 0x4e69,	/*UC ymap 2 3*/
	0x00d6, 0x8198,	/*UC ymap 4 5*/
	0x00d7, 0xadc2,	/*UC ymap 6 7*/
	0x00d8, 0xd6e9,	/*UC ymap 8 9*/
	0x00d9, 0xff00,	/*UC ymap10*/
	0x00da, 0x0f10,	/*UC hg ry*/
	0x00db, 0x1010,	/*UC hg gc*/
	0x00dc, 0x100f,	/*UC hg bm*/
	0x00ff, 0x0000,	/*Mask Release*/
	/*end*/
	END_SEQ, 0x0000
};

static unsigned short tune_camera_ove2[] = {
	/*start MC ove 2*/
	0x0000, 0x0000,	/*BANK 0*/
	0x0008, 0x04a0,	/*Dither8 UC4 ABC2 CP1 | CC8 MCM4 SCR2 SCC1 | CS8 DE4 DNR2 HDR1*/
	0x00e1, 0xff00,	/*SCR RrCr*/
	0x00e2, 0x14ff,	/*SCR RgCg*/
	0x00e3, 0x0aff,	/*SCR RbCb*/
	0x00e4, 0x00ff,	/*SCR GrMr*/
	0x00e5, 0xff00,	/*SCR GgMg*/
	0x00e6, 0x00f5,	/*SCR GbMb*/
	0x00e7, 0x00ff,	/*SCR BrYr*/
	0x00e8, 0x00f5,	/*SCR BgYg*/
	0x00e9, 0xff00,	/*SCR BbYb*/
	0x00ea, 0x00ff,	/*SCR KrWr*/
	0x00eb, 0x00ff,	/*SCR KgWg*/
	0x00ec, 0x00ff,	/*SCR KbWb*/
	...
	0x00d8, 0xd6e9,	/*UC ymap 8 9*/
	0x00d9, 0xff00,	/*UC ymap10*/
	0x00da, 0x0e10,	/*UC hg ry*/
	0x00db, 0x1010,	/*UC hg gc*/
	0x00dc, 0x100e,	/*UC hg bm*/
	0x00ff, 0x0000,	/*Mask Release*/
	/*end*/	/*end*/
	END_SEQ, 0x0000
};

static unsigned short tune_camera_ove3[] = {
	/*start MC ove 3*/
	0x0000, 0x0000,	/*BANK 0*/
	0x0008, 0x04a0,	/*Dither8 UC4 ABC2 CP1 | CC8 MCM4 SCR2 SCC1 | CS8 DE4 DNR2 HDR1*/
	0x00e1, 0xff00,	/*SCR RrCr*/
	0x00e2, 0x10ff,	/*SCR RgCg*/
	0x00e3, 0x00ff,	/*SCR RbCb*/
	0x00e4, 0x00ff,	/*SCR GrMr*/
	0x00e5, 0xff00,	/*SCR GgMg*/
	0x00e6, 0x00f0,	/*SCR GbMb*/
	0x00e7, 0x00ff,	/*SCR BrYr*/
	...
	0x00d8, 0xd6e9,	/*UC ymap 8 9*/
	0x00d9, 0xff00,	/*UC ymap10*/
	0x00da, 0x0c10,	/*UC hg ry*/
	0x00db, 0x1010,	/*UC hg gc*/
	0x00dc, 0x100c,	/*UC hg bm*/
	0x00ff, 0x0000,	/*Mask Release*/
	/*end*/
	END_SEQ, 0x0000
};
...
struct mdnie_tuning_info camera_table[LUX_MAX][MODE_MAX] = {
	{
		...
		{"camera_ove1",		tune_camera_ove1},
		{"camera_ove1",		tune_camera_ove1},
		{"camera_ove1",		tune_camera_ove1},
		{"camera_ove1",		tune_camera_ove1},
		{"camera_ove1",		tune_camera_ove1}
	}, {
		{"camera_ove2",		tune_camera_ove2},
		{"camera_ove2",		tune_camera_ove2},
		{"camera_ove2",		tune_camera_ove2},
		{"camera_ove2",		tune_camera_ove2},
		{"camera_ove2",		tune_camera_ove2}
	}, {
		{"camera_ove3",		tune_camera_ove3},
		{"camera_ove3",		tune_camera_ove3},
		{"camera_ove3",		tune_camera_ove3},
		{"camera_ove3",		tune_camera_ove3},
		{"camera_ove3",		tune_camera_ove3}
